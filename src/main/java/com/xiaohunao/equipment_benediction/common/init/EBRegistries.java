...
public class EBRegistries {
    ...
    public static final Registry<MapCodec<? extends IWearable>> EQUIPPABLE_CODEC = new RegistryBuilder<>(Keys.EQUIPPABLE_CODEC).create();


    public static class Keys {
        public static final ResourceKey<Registry<HookType<?>>> HOOK_TYPES = EquipmentBenediction.asResourceKey("hook_type");
        public static final ResourceKey<Registry<MapCodec<? extends IWearable>>> EQUIPPABLE_CODEC = EquipmentBenediction.asResourceKey("equippable");
    }

    public static final class Suppliers {
        public static final Supplier<Registry<HookType<?>>> HOOK_TYPES = supplyRegistry(Keys.HOOK_TYPES);
        public static final Supplier<Registry<MapCodec<? extends IWearable>>> EQUIPPABLE_CODEC = supplyRegistry(Keys.EQUIPPABLE_CODEC);
    }
